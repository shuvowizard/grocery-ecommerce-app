                        ...
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                <div class="profile-photo">
                                    <img src="{{ auth()->guard('web')->user()->photo ? asset('uploads/user/' . auth()->guard('web')->user()->photo) : asset('uploads/default.png') }}" alt="user profile photo">
                                </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0">
                                    <a href="customer-dashboard.html" class="text-decoration-none text-dark fw-bold">
                                ...
                                <li class="list-group-item px-0">
                                    <a href="customer-profile.html" class="text-decoration-none text-dark">
