...
@section('content')
    ...
    {{-- Breadcrumb --}}
    <section class="breadcrumb-section py-3 bg-light no-print">
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-success">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('orders') }}" class="text-success">My Orders</a></li>
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="0">
                                            <tr>
                                                <td width="50%" style="vertical-align: top;">
                                                    ...
                                                    <p style="margin: 0;"><strong>{{ $order->billing_name }}</strong></p>
                                            ...
                                            <tr>
                                                <td width="40%" style="vertical-align: top;">
                                                    <table width="100%" cellpadding="5" cellspacing="0">
                                                        <tr>
                                                            <td width="50%" style="vertical-align: top;">
                                                                <h6 style="margin: 0 0 10px 0; font-weight: bold;">Payment
                                                                    Method:</h6>
                                                ...
                                                <td width="40%">
                                                    <table width="100%" cellpadding="8" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right; padding: 0; font-weight: bold;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right; padding: 0;">
                                                                ${{ number_format($order->delivery_option_cost, 2) }}</td>
                                                        </tr>
