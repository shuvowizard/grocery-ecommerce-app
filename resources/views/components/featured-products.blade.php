                    ...
                    <div class="card product-card h-100 border-0 shadow-sm">
                        <a href="{{ route('product', $product->slug) }}" class="text-decoration-none text-dark">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute top-0 inset-e-0 m-2 d-flex flex-column gap-1 align-items-start">
                                    @if($product->is_new)
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        @if($variation)
                                            <span class="text-success fw-bold fs-5">${{ number_format($variation->sale_price, 2) }}</span>
                                            @if($hasDiscount)
